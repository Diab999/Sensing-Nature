...
@section('content')
<section class="page-section bg-light" id="project-details">
                ...
                <div class="card shadow border-0" style="border-radius: 1rem; overflow: hidden;">
                    ...
                    <div class="card-body" style="padding: 1.75rem 1.5rem;">
                        ...
                        @if($project->project_date)
                            <div class="mb-3 small" style="color:#f4623a;">
                        ...
                        <a href="{{ route(app()->getLocale() . '.projects.index') }}" class="btn mt-3" style="background:#f4623a;color:#fff;border:none;border-radius:0.5rem;padding:0.5rem 1.25rem;">{{ __('messages.back_to_projects') }}</a>
                    </div>
                </div>
            </div>
        </div>
